...
namespace XFLoadFromXaml.Infrastructure.Controls
{
        ...
        Picker
    {
        ...
        public static readonly BindableProperty SelectedItemProperty = BindableProperty.Create("SelectedItem", typeof(object), typeof(BindablePicker), null, BindingMode.OneWay, null, new BindableProperty.BindingPropertyChangedDelegate(BindablePicker.OnSelectedItemChanged), null, null, null);
        ...
        static void loadItemsAndSetSelected(BindableObject bindable)
        {
            ...
            {
                int count = 0;
                foreach (var obj in (IEnumerable)picker.ItemsSource)
                {
